...
| snacks-branded-foods.<br> ***Steps to replicate***:<br> 1) none of the filters are working <br>2) Sort applied can be relevance, Alplabetical, Price - High to Low| `http://localhost:3000/cl/beverages/` | ***filters***: <br>Price = Less than Rs 20 |
